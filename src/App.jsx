...
export default function App() {
  ...
  if (loading) return (
    <div style={{...s.root, alignItems:"center", justifyContent:"center"}}>
      <style>{css}</style>
      <div style={s.brandHero}>NoSingle</div>
  ...
  if (screen==="auth") return (
    <div style={{...s.root, justifyContent:"space-between", padding:"64px 28px 48px"}}>
      <style>{css}</style>
      <div>
        <div style={s.brandHero} className="fade-up">NoSingle</div>
    ...
    <div style={{...s.root,padding:"48px 28px 32px"}}>
      ...
      {setupStep===2 && (
        <div className="fade-up">
          ...
          <div style={s.setupSub}>Just the basics.</div>
...
const s = {
  ...
  brandHero:{ fontSize:44, fontWeight:700, color:C.ink, letterSpacing:-1.5 },
  brand:{ fontSize:22, fontWeight:700, color:C.ink, letterSpacing:-0.5 },
